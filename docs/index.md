...
**[TASK: Add example cost functions that represent the breadth of cost functions across destinations.]**
...
**[TASK: List all business rules & take a first pass at all values in the table.]**

# Data Exchange Overview

![Data Exchange Diagram](./attachments/DataExchangeDiagram.png)
